...
export function ReasoningBasic() {
  const reasoningText = `Based on your goals and timelines, we recommend starting with the design assets this week and moving into development by Monday. This ensures we hit your launch date while keeping every stage smooth and collaborative.`;
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          >
            <p className="text-sm">
              Hey, I need help getting our new website and brand visuals
              launched on time. Can you suggest the best way to get everything
              aligned?
            </p>
          </motion.div>
